...
struct jit_callbacks_struct {
   ...
   void                 (*vm_send_woblock_jit_inline_frame_f)(rb_thread_t *th, CALL_INFO ci, CALL_CACHE cc, VALUE recv);
   VALUE                (*vm_send_woblock_inlineable_guard_f)(CALL_CACHE cc, VALUE klass);
