...
/** 
 * 
 * This struct contains function pointers that are used by the JIT to generate 
 * calls to VM functionality.  
 *
 * The function pointers can be broken into two groups.
 * 
 * - The first group are generated callbacks; These are generated by processing
 *   insns.def, the instruction definition file. 
 *
 * - The second group contains regular VM functions that the JIT may wish to 
 *   generate calls to.  
 */
struct jit_callback_pointers {
