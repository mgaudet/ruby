...
#ifdef JIT_INTERFACE
jit_globals_t generate_globals(rb_vm_t* vm) { 
   jit_globals_t globals;

   globals.ruby_vm_class_serial_ptr          = &ruby_vm_class_serial;
   globals.ruby_vm_global_method_state_ptr   = &ruby_vm_global_method_state;
